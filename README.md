...
| ---------- | ----------- | --------------- |
| `kallsyms_addresses`
| (or `kallsyms_offsets` + |  The addresses (or offsets relative to a base, in recent kernels) of each symbol, as an array
| `kallsyms_relative_base`) | `80 82 00 C0  80 82 00 C0  80 82 00 C0  0C 84 00 C0  B4 84 00 C0  5C 85 00 C0  60 85 00 C0  60 85 00 C0` ...
