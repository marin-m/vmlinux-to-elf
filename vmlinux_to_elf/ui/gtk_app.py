...
RESOURCES_PATH = realpath(join(ASSETS_DIR, 'vmlinux-to-elf.gresource'))
...
@Gtk.Template(resource_path='/re/fossplant/vmlinux-to-elf/gui-autogenerated.ui')
